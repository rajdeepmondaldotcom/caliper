...
def init(
    ...
    template = (
        ...
        "\n"
        "# Default rolling window (in days) for every command that doesn't\n"
        "# take an explicit --since/--until/--days. Keep it equal to the\n"
        "# [dashboard] default_days below so the CLI and dashboard agree.\n"
        "default_days = 14\n"
