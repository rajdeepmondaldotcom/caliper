...
MODEL_TAXONOMY: tuple[ModelTaxonomyEntry, ...] = (
    ModelTaxonomyEntry(
        "openai-codex", "gpt-5.5-pro", "gpt-5.5-pro", "gpt", "5.5", "pro", "premium"
    ),
    ModelTaxonomyEntry("openai-codex", "gpt-5.5", "gpt-5.5", "gpt", "5.5", "", "frontier"),
    ModelTaxonomyEntry(
        "openai-codex", "gpt-5.4-pro", "gpt-5.4-pro", "gpt", "5.4", "pro", "premium"
    ),
    ModelTaxonomyEntry(
        "openai-codex", "gpt-5.4-mini", "gpt-5.4-mini", "gpt", "5.4", "mini", "small"
    ),
    ModelTaxonomyEntry(
        "openai-codex", "gpt-5.4-nano", "gpt-5.4-nano", "gpt", "5.4", "nano", "small"
    ),
    ModelTaxonomyEntry("openai-codex", "chat-latest", "chat-latest", "chat", "latest", "", "chat"),
