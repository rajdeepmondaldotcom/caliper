...
def sample_dashboard(banner: Banner | None = None, show_paths: bool = False) -> Dashboard:
    return Dashboard(
        ...
        log_signals=LogSignals(
            cost_source_label="Mixed source",
            cost_source_detail="124 vendor-reported · 356 calculated",
            cache_read_input_tokens=2_420_000,
            cache_creation_input_tokens=280_000,
            cache_creation_input_1h_tokens=100_000,
            reasoning_output_tokens=82_000,
            latency_sample_count=320,
            median_latency_ms=4200,
            p95_latency_ms=11800,
            tool_result_count=510,
            tool_error_count=18,
            lines_added=12_480,
            lines_removed=5_140,
