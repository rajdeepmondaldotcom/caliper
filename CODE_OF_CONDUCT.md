...
Caliper follows the Contributor Covenant Code of Conduct, version 2.1.
...
standards. Maintainers may remove, edit, or reject comments, commits,
code, issues, pull requests, and other contributions that are not aligned
with this Code of Conduct.

Instances of abusive, harassing, or otherwise unacceptable behavior may
be reported through GitHub Private Vulnerability Reporting if the report
has a security dimension, or directly to the project maintainer through
the contact details listed on the maintainer's GitHub profile.
