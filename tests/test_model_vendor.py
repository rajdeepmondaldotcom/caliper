...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("claude-opus-4.8", VENDOR_ANTHROPIC),
        ("claude-opus-4.5", VENDOR_ANTHROPIC),
        ("claude-fable-5", VENDOR_ANTHROPIC),
        ("claude-mythos-5", VENDOR_ANTHROPIC),
        ("claude-sonnet-4.5", VENDOR_ANTHROPIC),
        ...
        ("gpt-5.5-pro", VENDOR_OPENAI),
        ("gpt-5.4-pro", VENDOR_OPENAI),
        ("gpt-5.4-nano", VENDOR_OPENAI),
        ("chat-latest", VENDOR_OPENAI),
