...
"built with Claude" / "written by Claude" / "generated by Claude"
attribution lines. Past commits are left as-is.
...
`tests/test_attribution_policy.py` enforces this on every tracked
file outside the documented whitelist.
